...
Password Complexity: Numbers and Characters""")
my_subwindow.add(help_text, 1, 1, align='left')
...
and user experience. This tool leverages the Have I Been Pwned API to ensure your passwords are not compromised"""
                      )
my_subwindow2.add(about_text, 1, 1, align='left')
